...
var translations = {
	...
	"nap" : {
		...
		"goToSubReddit" : "Vaje 'ngopp 'o Subreddit",
		"evalJSCode" : "Seguisce 'o cumanno JS",
		"openFolder" : "Arape <title>",
		"goBack" : "Và arete",
		"openShortcut" : "Arape 'a scorciatoje",
		...
		"exportNotif" : "'E preferenze toje anna state esportate e cupiate 'ind a l'appunti, mietti 'stu codice addò vuò tu ppe recuperà.",
		...
		"switchEngineWithArrows" : "Cagna 'o mutore e ricirca 'che buttun 🠕 e 🠗 'dda tastiera",
		"enableAltShortcut" : "Arape segnalibbri e cartelle 'ccu ALT 'cchiù 'nu buttone numerico 'dda tastiera",
		"numPadInstead" : "Usa 'o tastierino 'dde nummere appost' 'dde nummeri principali",
		"langAndTheme" : "Lengua e personalizzazione",
		"showSettingsIcon" : "Mustra l'icona 'dde preferenze 'ngopp a destra",
		"enableAnimations" : "Appiccia l'animazioni",
		"launchURLwhenClicked" : "Vaje al l'URL/'ngopp 'o Subreddit digitate quanne si premme 'cco mouse",
		"resizeSearchFont" : "Accongia 'a grandezza 'ddo testo quanne scrive (si 'o tema o supporta)",
		"applyColorTheme" : "CAGNA CULORE O TEMA (COMME FA TELEGRAM)",
		"resetAndImport" : "Reset e 'mpurtazione",
		"settingsExport" : "Esporta Preferenze",
		"settingsReset" : "Cancielle tutt'e Preferenze",
		"settingsClose" : "Chiure",
		"contextDefault" : "Fa 'ddiventà predefinito",
		...
		"useFaviconIco" : "Usa favicon.ico appost' 'dde DuckDuckGo API",
		"useOldReddit" : "Usa old.reddit.com quanne se va 'ngopp 'a 'nu subreddit",
		"moveIntoFolder" : "Spuoste int'a 'na cartella",
		"addNewFolder" : "Miette int'a 'na cartella nova",
		"useExistingFolder" : "Spuoste int'a 'nata cartella",
		"noOtherFolders" : "Nun è maje criato 'na cartella.",
		"folderUndo" : "Annulle", 
		"materialIconsRedirect" : "Può truvà tutt'è codici dell'icone supportate 'ngopp 'o site Material Design Icons",
		"toFolder" : "O' signalibbro è state spustate int' a 'na cartella",
		"emptyFolder" : "Cartella vacante",
	},
}
